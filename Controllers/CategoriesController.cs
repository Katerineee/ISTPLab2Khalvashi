...
namespace LAB2ISTPP.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        public async Task<IActionResult> DeleteCategory(int id)
        {
            ...
            // Поиск всех новостей, связанных с данной категорией
            var newsList = await _context.News.Where(n => n.CategoryId == id).ToListAsync();

            // Удаление всех новостей
            _context.News.RemoveRange(newsList);
